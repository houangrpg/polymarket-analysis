...
def generate_dashboard():
    ...
    # Write to a separate auto-updated file to avoid overwriting the curated combined.html
    auto_path = 'combined_auto.html'
    with open(auto_path, 'w') as f: f.write(full_html)
    # Also keep a timestamped backup for auditing
    try:
